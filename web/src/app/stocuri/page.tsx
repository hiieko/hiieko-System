              ...
              {stockBalances.length === 0 && materials.length === 0 ? (
                ...
                stockBalances.map((balance) => {
                  ...
                  return (
                    <tr key={balance.id} className="hover:bg-slate-50 transition-colors">
                      <td className="py-3.5 px-4 font-mono font-bold text-slate-900">{mat?.code || 'â€”'}</td>
                      <td className="py-3.5 px-4 font-medium text-slate-800">{mat?.name || 'Material Necunoscut'}</td>
                      <td className="py-3.5 px-4 text-xs text-slate-500">{mat?.category || 'â€”'}</td>
                      <td className="py-3.5 px-4 font-mono text-xs text-slate-600">{mat?.barcode || 'â€”'}</td>
                ...
                materials.map((material) => (
                  <tr key={material.id} className="hover:bg-slate-50 transition-colors opacity-60">
                    ...
                    <td className="py-3.5 px-4 text-xs text-slate-500">{material.category || 'â€”'}</td>
                    <td className="py-3.5 px-4 font-mono text-xs text-slate-600">{material.barcode || 'â€”'}</td>
                ...
                stockMovements.map((mv) => {
                  ...
                  return (
                    <tr key={mv.id} className="hover:bg-slate-50">
                      ...
                      <td className="py-3 px-4 font-mono text-slate-500">{mv.notes || 'â€”'}</td>
                    </tr>
                  );
                })
              )}
