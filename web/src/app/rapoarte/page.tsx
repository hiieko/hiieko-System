      ...
      {loading ? (
        ...
        <div className="space-y-6">
          {reports.map((report) => {
            ...
            const siteCode = report.project?.code || 'â€”';
            ...
            const materialsUsed = (report.materials || []).map(m => ({
              ...
              material_code: m.material?.code || 'â€”',
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500 mt-1 flex items-center space-x-4">
                    <span className="flex items-center">
                      ...
                      Data: <strong className="ml-1 text-slate-700">{report.report_date?.toString().split('T')[0] || 'â€”'}</strong>
                    </span>
                    <span>â€¢</span>
                    <span>
